      ...
      <div class="container">
          ...
          <div class="row">
            ...
            <div class="col-8 card text-center text-white bg-warning">
              <div class="card-body">
                <p class="card-text">
                  <h3>บันทึกข้อมูลแล้ว</h3><br>
                </p>
                          <button type="button" class="btn btn-success" onclick="location.href='home_officer.php'">กลับไปหน้าหลัก</button>
              </div>
            </div>
            <div class="col">
            </div>
